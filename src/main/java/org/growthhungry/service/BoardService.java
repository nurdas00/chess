...
public class BoardService {
    ...
    private final boolean USE_UNICODE = false;
    ...
    private Coordinate getCoordinate(String c) {
        c = c.trim();
        if (c.length() != 2) {
    ...
    private String asciiFor(PieceType t, Color c) {
        char ch = switch (t) {
            case KING -> 'K';
            case QUEEN -> 'Q';
            case ROOK -> 'R';
    ...
    private String unicodeFor(PieceType t, Color c) {
        return switch (t) {
